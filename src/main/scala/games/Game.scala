...
import boards.Board
import boards.Board.numberOfShips
import boards.coordinates.Coordinate
import boards.directions.domain.Direction
import cats.implicits.catsSyntaxEitherId
import cats.syntax.all.*
import boards.*
import games.errors.*
import games.phases.{PlacingPhase, PlayingPhase}
import games.status.{GameStatus, OnGoing, WaitingForPlayers, Won}

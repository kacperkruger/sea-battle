...
import kacperkruger.seabattle.boards.errors.{
  BoardError,
  CanNotPlaceShip,
  CanNotShootToShotField,
  CoordinateOutOfOrder
}
import kacperkruger.seabattle.boards.fields.FieldStatus
import kacperkruger.seabattle.ships.Ship
import kacperkruger.seabattle.utilities.times
